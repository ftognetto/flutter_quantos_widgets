...
class AsyncButton extends StatefulWidget {
  ...
  const AsyncButton.icon({ required Widget this.icon, this.busyIcon, this.onPressed, this.color = Colors.grey, this.loadingColor, Key? key}) : 
  ...
  const AsyncButton.raisedButton({required Text this.text, this.onPressed, this.color = Colors.grey, this.borderRadius = BorderRadius.zero, this.loadingColor, Key? key}):
  ...
  const AsyncButton.outlineButton({required Text this.text, this.onPressed, this.color = Colors.grey, this.borderRadius = BorderRadius.zero, this.loadingColor, Key? key}):
  ...
  const AsyncButton.flatButton({required Text this.text, this.onPressed, this.color = Colors.grey, this.loadingColor, Key? key}):
